...
const EmpCreate = () => {
    ...
    const handleSubmit=(e)=>{
        ...
        fetch("http://localhost:8000/employee",{
            ...
            console.log("the response add", response)
    ...
    return (
        ...
        <div className='card'>
            ...
            <div className="mb-3">
                    ...
                    <input type="text" className="form-control" value={empName}  id="exampleInputText1" onChange={(e)=>setEmpName(e.target.value)} aria-describedby="emailHelp"/>
                </div>
                <div className="mb-3">
                    <label for="exampleInputEmail1" className="form-label" >Email address</label>
                    <input type="email" className="form-control" value={empEmail} id="exampleInputEmail1" onChange={(e)=>setEmpEmail(e.target.value)} aria-describedby="emailHelp"/>
                </div>
                <div className="mb-3">
