...
const EmpEdit = () => {
  ...
  useEffect(()=>{
    fetch(`http://localhost:8000/employee/${id}`,{
      ...
      console.log("the response data i edit", data)
        ...
        <div className='card'>
          ...
          <form>
               <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="exampleInputText1" onChange={(e)=>{setEmpName(data.name),setEmpName(e.target.value)}} aria-describedby="emailHelp"/>
                </div>
                <div className="mb-3">
